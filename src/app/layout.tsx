...
export const metadata: Metadata = {
  title: "CampaignForge Copilot | Campaign Forge",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${inter.variable} ${outfit.variable} ${playfair.variable} ${spaceGrotesk.variable} ${jakarta.variable} font-sans antialiased bg-slate-50 dark:bg-slate-950`}
      >
        {children}
      </body>
    </html>
